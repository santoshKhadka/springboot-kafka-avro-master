...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1611651138873341811L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"dbserver1.shopping.product\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"price\",\"type\":[\"null\",\"double\"],\"default\":null},{\"name\":\"description\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}],\"connect.name\":\"dbserver1.shopping.product.Value\"}");
   ...
   */
  public Value(java.lang.Integer id, java.lang.String name, java.lang.Double price, java.lang.String description) {
    this.id = id;
    this.name = name;
    this.price = price;
   ...
   */
  public static dbserver1.shopping.product.Value.Builder newBuilder() {
    return new dbserver1.shopping.product.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static dbserver1.shopping.product.Value.Builder newBuilder(dbserver1.shopping.product.Value.Builder other) {
    if (other == null) {
      return new dbserver1.shopping.product.Value.Builder();
    } else {
      return new dbserver1.shopping.product.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static dbserver1.shopping.product.Value.Builder newBuilder(dbserver1.shopping.product.Value other) {
    if (other == null) {
      return new dbserver1.shopping.product.Value.Builder();
    } else {
      return new dbserver1.shopping.product.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dbserver1.shopping.product.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dbserver1.shopping.product.Value other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder setPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dbserver1.shopping.product.Value.Builder clearDescription() {
      description = null;
